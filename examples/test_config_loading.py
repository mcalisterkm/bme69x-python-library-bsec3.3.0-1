...
def test_binary_config_loading():
    ...
    # Copy binary config
    src = 'bsec_v3-3-0-1/release_bin/Sel_IAQ/config/bme690/bme690_sel_33v_3s_4d/bsec_selectivity.config'
...
def test_config_equivalence():
    ...
    # Load binary config
    binary_file = 'bsec_v3-3-0-1/release_bin/Sel_IAQ/config/bme690/bme690_sel_33v_3s_4d/bsec_selectivity.config'
