...
- Bosch BSEC 3.3.0.1 integration guide: refer to `bsec_v3-3-0-1/integration_guide`, which is part of the BSEC3 package from Bosch Sensortec: [here](https://www.bosch-sensortec.com/software-tools/software/bme688-and-bme690-software/#Library)
