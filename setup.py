...
if BSEC3 == '64':
    algo = 'bsec_v3-3-0-1/release_bin/Sel_IAQ/bin/RaspberryPi/PiFour_Armv8'
    # 64 bit Raspbian OS - PI 4 and PI5, ARM V8A, ARM V8.2-A  Must be 64 bit OS
elif BSEC3 == '32':
    algo = 'bsec_v3-3-0-1/release_bin/Sel_IAQ/bin/RaspberryPi/PiThree_ArmV8'
    # 32bit Raspbian OS - PI 5 / 4 / 3 /  Zero 2, ARM V8A  Must be 32bit  OS
else:
    algo = 'bsec_v3-3-0-1/release_bin/Sel_IAQ/bin/RaspberryPi/PiThree_ArmV6'
...
if BSEC:
    ...
    REQUIRED_SYMBOLS = ['bsec_init', 'bsec_get_version', 'bsec_get_instance_size']
    try:
...
include_dirs=['/usr/local/include', 'bsec_v3-3-0-1/release_bin/Sel_IAQ/inc']
...
setup(name='bme69x',
      ...
      url='https://github.com/mcalisterkm/bme68x-python-library-bsec3.3.0.1',
      author='Multiple',
      author_email='',
      license='MIT',
      classifiers=[
      ...
      package_data={
          'bme69x': [
               'bsec_v3-3-0-1/release_bin/Sel_IAQ/config/bme690/bme690_sel_33v_3s_4d/bsec_selectivity.config',
          ]
      },
